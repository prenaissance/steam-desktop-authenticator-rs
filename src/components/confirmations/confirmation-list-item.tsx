...
export const ConfirmationListItem = ({
  ...
  return (
    <li className={cn("w-full", className)} {...props}>
      <Link
        className="flex w-full gap-2 rounded-xs border border-zinc-600 bg-zinc-800 py-1 transition-colors duration-300 hover:border-zinc-500 hover:bg-zinc-700 focus-visible:bg-zinc-700"
